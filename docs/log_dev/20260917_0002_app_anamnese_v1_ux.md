# RELATÓRIO 20260917_0002 — App Anamnese V1 UX (Captura Inteligente, Separação Cálculo×Meta, Histórico)

**Nota de renumeração (merge de 2026-09-17):** este relatório nasceu como `20260917_0001` na branch `feat/app-anamnese-v1-ux` (commitado antes de `feat/web-anamnese-profissional` existir). No merge para `main`, colidiu com `20260917_0001_web_anamnese_profissional.md` (já mesclado e referenciado em commits) — renomeado para `0002` para resolver a colisão; conteúdo idêntico ao commit original, só o nome do arquivo/número mudou.
